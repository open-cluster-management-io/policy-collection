...
As described in [NIST Special Publication 800-53 (Rev. 4)](https://nvd.nist.gov/800-53/Rev4/control/CA-1), use Security Assessment and Authorization to implement policies for the selected security controls and control enhancements. 
