...
[Gatekeeper operator policy](./CM-Configuration-Management/policy-gatekeeper-operator.yaml) | Use the Gatekeeper operator policy to install Gatkeeper (community version) on a managed cluster | See the [Gatekeeper Operator](https://github.com/gatekeeper/gatekeeper-operator).
