...
[Example of configuring audit logging with a policy](./CM-Configuration-Management/policy-openshift-audit-logs-sample.yaml) | Use this policy to configure audit logging in your OpenShift Cluster. For example, you can view audit logs on kibana console. | See the [OpenShift Documentation](https://access.redhat.com/documentation/en-us/openshift_container_platform/4.6/html/logging/cluster-logging) This policy is only valid for OpenShift 4.6.x and needs to be adjusted for the proper environment.
