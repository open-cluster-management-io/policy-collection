...
[Example of creating a xcrypt deployment object](./CM-Configuration-Management/policy-ztc-cmc-deployment.yaml) | This example deploys a replica of \`zts-cmc-pod\`. | See the [Kubernetes Documentation](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) to learn more about Deployments.
