...
[Policy Report Failures](./CM-Configuration-Management/policy-check-reports.yaml)| The Policy Report Failures policy will search for any Policy Report resources that contain failures in the results. | An example of a tool that creates PolicyReports is [Kyverno](ihttps://kyverno.io/).  Other tools will likely create policy reports in the future.
