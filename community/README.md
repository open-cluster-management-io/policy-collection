...
[Policy to setup OCS](./CM-Configuration-Management/policy-ocs-setup.yaml) | Use this policy to install and configure the OpenShift Data Foundation Operator  | making it work would require e.g. on AWS m5 instances would be required. Requires OpenShift 4.6 or later.
[Policy to install Kyverno](./CM-Configuration-Management/policy-kyverno.yaml) | Use this policy to install Kyverno | consult the following [link](https://github.com/kyverno) to get more information about Kyverno.
