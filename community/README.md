...
[Policy to install the Advanced Cluster Security Central Server](./CM-Configuration-Management/policy-acs-operator-central.yaml) | Use this policy to install the Advanced Cluster Security operator to the ACM hub and install the Central Server to the stackrox namespace. | For more information on Advanced Cluster Security, visit [Red Hat Advanced Cluster Security for Kubernetes](https://www.openshift.com/products/kubernetes-security)
