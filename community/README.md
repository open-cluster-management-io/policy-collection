...
[Configure-Logforwarding](./CM-Configuration-Management/policy-configure-logforwarding.yaml) | Use this policy to configure Logforwarding| see this blog for more info about this example [https://www.openshift.com/blog/implement-policy-based-governance-using-configuration-management-of-red-hat-advanced-cluster-management-for-kubernetes](https://www.openshift.com/blog/implement-policy-based-governance-using-conf)
[Install OpenShift-Update-Service](./CM-Configuration-Management/policy-update-service-openshift-cluster.yaml) | Use this policy to install the OpenShift Update Service. | This policy is only valid for OpenShift 4.6+. Read [here](https://docs.openshift.com/container-platform/4.6/updating/installing-update-service.html#installing-update-service) for more information
[Check Fips-Compliance] (./CM-Configuration-Management/policy-update-service-openshift-cluster.yaml) Use this policy to check if a Cluster has FIPS-Compliance-Enabled. | This policy is only valid for OpenShift 4.6+. Read [here](https://docs.openshift.com/container-platform/4.7/installing/installing-fips.html) for more information
[Install OpenShift-Gitops](./CM-Configuration-Management/policy-openshift-gitops.yaml) use This Policy to install the Gitops-Operator| Check our [documentation](https://access.redhat.com/documentation/en-us/openshift_container_platform/4.7/html/cicd/gitops) for more information  
