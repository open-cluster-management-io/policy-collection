...
* [Tips for using templating in Governance Policies - Part 1](https://www.redhat.com/en/blog/tips-for-using-templating-in-governance-policies-part-1)
...
* [Use Advanced Cluster Management(ACM) templates to manage Users,Groups and Namespaces](https://medium.com/@moyo.oyegunle/use-advanced-cluster-management-acm-templates-to-manage-users-groups-and-namespaces-e07a280f84c5)

* [Advanced Cluster Management Updates](https://myopenshiftblog.com/advanced-cluster-management-updates/)

* [A proposed project layout for GitOps-managed policies in Red Hat Advanced Cluster Management (RHACM)](https://github.com/redhat-cop/acm-policies)

## Easy Policy adoption with the Policy Generator
...
* [Securing Ingress Controllers on a Managed OpenShift Cluster using Red Hat Advanced Cluster Management](https://www.redhat.com/en/blog/securing-ingress-controllers-on-a-managed-openshift-cluster-using-red-hat-advanced-cluster-management)
...
* [How to use the Certificate Policy Controller to Identify Risks in Red Hat Advanced Cluster Management for Kubernetes](https://cloud.redhat.com/blog/how-to-use-the-certificate-policy-controller-to-identify-risks-in-red-hat-advanced-cluster-management-for-kubernetes)
